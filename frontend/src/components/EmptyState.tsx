...
export default function EmptyState({ title = 'No results found', message = 'Try expanding your search parameters or check back later.', actionLabel = null, onAction = null }) {
  return (
    <div className="flex flex-col items-center justify-center text-center p-8 md:p-12 bg-slate-850 dark:bg-slate-850 border border-slate-100 dark:border-slate-800 rounded-2xl shadow-sm">
